                ...
                <a class="d-flex p-3 border-bottom" href="#">
                  ...
                  <div class="mr-3">
                    <h5 class="notification-label mb-1">
                      <a href="{{ route('postShow', $notification->data['news_id']) }}">
        ...
        <div class="dropdown main-profile-menu nav nav-item nav-link">
          ...
          <a class="profile-user d-flex" href="">
            @if (Auth::check() && isset(Auth::user()->image) && !is_null(Auth::user()->image->url))
              <img alt="" src="{{ asset('images/' . Auth::user()->image->url) }}">
            @else
          ...
          <div class="dropdown-menu">
            ...
            <a class="dropdown-item" href="{{ route('edit_profile') }}"><i class="bx bx-cog"></i> Edit
              Profile</a>
