        ...
        <div class="">
          ...
          <a class="profile-user d-flex" href="">
            @if (Auth::check() && isset(Auth::user()->image) && !is_null(Auth::user()->image->url))
              <img alt="user-img"
                class="avatar avatar-xl brround"src="{{ asset('images/' . Auth::user()->image->url) }}">
            @else
              <img alt="user-img" class="avatar avatar-xl brround"src="{{ asset('/images/download.jfif') }}">
            @endif
          </a>
      ...
      @can('News')
        <li class="slide">
          ...
          <ul class="slide-menu">
            ...
            @can('saved records')
              <li><a class="slide-item" href="{{ url('/' . ($page = 'showSave')) }}"> saved records</a></li>
            @endcan
      ...
      @can('Users')
        ...
        <li class="slide">
          ...
          <ul class="slide-menu">
            ...
            @can('Users Roles')
              <li><a class="slide-item" href="{{ url('/' . ($page = 'roles')) }}">Users Roles </a></li>
            @endcan
          </ul>
        </li>
      @endcan
