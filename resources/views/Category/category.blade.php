                  ...
                  @foreach ($category as $cat)
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        @if ($cat->image)
                          <img src="{{ asset('images/' . $cat->image->url) }}" alt="Category Image"
                      ...
                      <td>
                        ...
                        @can('Delete category')
                          <a class="modal-effect btn btn-sm btn-danger" data-toggle="modal"
                            href="#delete{{ $cat->id }}" title="delete">
                              ...
                              <form action="{{ route('Categories.update', 'test') }}" method="POST" autocomplete="off"
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="file" name="image" class="form-control" id="exampleInputfile"
                                    value="{{ asset('images/' . $cat->image->url) }}">
                                </div>
                                @if ($cat->image)
                                  <img src="{{ asset('images/' . $cat->image->url) }}" alt="Category Image"
                                    style="width:70px;height:70px">
                      ...
                      <!-- delete -->
                      <div class="modal" id="delete{{ $cat->id }}">
          ...
          <div class="modal-body">
            <form action="{{ route('Categories.store') }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="section_name" required name="cate_name">
              </div>
